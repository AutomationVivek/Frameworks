...
public class MergeAccountsusingInterface extends ProjectMethods{
	@Test(dependsOnMethods= {"week4.testng.account.tcs.CreateAccountUsingInterface.CreateAccount"})
